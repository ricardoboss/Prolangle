...
/// <param name="guessGame">The underlying game. Also used as seed source for jitter.</param>
...
public partial class SnippetRevealer(GuessGame guessGame, string sourceCode, bool useJitter)
{
